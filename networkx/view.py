...
graph_data_nodes = np.loadtxt('exports/nodes.csv', dtype='str', delimiter=',', encoding="utf-8-sig")
graph_data_edges = np.loadtxt('exports/edges.csv', dtype='str', delimiter=',', encoding="utf-8-sig")
